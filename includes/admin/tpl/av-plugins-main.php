<div class="container-fluid" id="av-container">
	...
	<?php if (($active_count = count($av_plugins)) > 0) { ?>
		<div class="av-title-logo mt-3">
			<div class="av-fs-180"><?php _e('Installed plugins', 'dln-subscribe'); ?></div>
			<p><?php _e('List of active AV Plugins on your site. Click on the plugin to go to the settings page.', 'dln-subscribe'); ?></p>
		</div>
