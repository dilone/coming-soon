...
function DLN_CS_admin_menus()
{
	...
	if (count($av_plugins) > 1) {
		...
		if (empty($GLOBALS['admin_page_hooks']['AV_themes_plugin_options'])) {
			...
			add_menu_page(
				__('AV Themes & Plugins Options', 'dln-coming-soon'), // page title
				__('AV Settings', 'dln-coming-soon'), // menu title
	...
	add_submenu_page(
		...
		__('AV Coming Soon Options', 'dln-coming-soon'), // page title
		__('Coming Soon', 'dln-coming-soon'), // menu title
		'edit_theme_options', // user capability
		DLN_CS_PLUGIN_SETTING_PAGE,	// menu slug
		'DLN_CS_plugin_options_page', // menu callback function
		100 // position
	);
}
